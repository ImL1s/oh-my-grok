...
OMG_OWNER_PATTERNS: dict[str, tuple[str, ...]] = {
    "OMG-W0": tuple(
        ...
        + [
            ...
            "omg_cli/parity_issue_state.py",
            "omg_cli/parity_ownership.py",
        ]
        ...
        + [
            ...
            "docs/parity/issue-state/**",
            "docs/parity/projections/**",
    ...
    "OMG-W3": tuple(
        ...
        + [
            "omg_cli/team/approval.py",
            "omg_cli/team/cleanup.py",
            "omg_cli/team/identity.py",
            "omg_cli/team/interactive.py",
            "omg_cli/team/interactive_wrapper.py",
            "omg_cli/team/io_capability.py",
            "omg_cli/team/monitor.py",
            "omg_cli/team/notify.py",
            "omg_cli/team/prompt_queue.py",
            "omg_cli/team/task_batch.py",
            "omg_cli/team/worker_protocol.py",
            "docs/team-operation-catalog-v5.md",
            "docs/team-operation-catalog-v6.md",
            "tests/golden/team_operation_catalog_v4.json",
            "tests/golden/team_operation_catalog_v5.json",
            "tests/golden/team_operation_catalog_v6.json",
        ]
        ...
        + _paths(
            ...
            (
                ...
                "test_team_view.py",
                "test_team_broadcast.py",
                "test_team_composition_execution.py",
                "test_team_composition_lane_protocol.py",
                "test_team_composition_task_driver.py",
                "test_team_interactive.py",
                "test_team_interactive_tmux.py",
                "test_team_io_capability.py",
                "test_team_pane_launch_nonce.py",
                "test_team_prompt_queue.py",
                "test_team_tmux_harness.py",
                "test_team_worker_preflight.py",
                "test_team_worker_protocol.py",
            ),
        )
    ),
    "OMG-W4": tuple(
        ...
        + [
            ...
            "agents/catalog.json",
            "agents/catalog.yaml",
            "agents/model_policies.json",
            "skills/**",
            "scripts/generate_capabilities_lock.py",
            "scripts/generate_agents_catalog.py",
            "scripts/generate_antigravity_agent_projections.py",
            "scripts/generate_antigravity_hook_projection.py",
            "scripts/generate_antigravity_skill_projections.py",
            "hooks/bin/antigravity_hook.py",
            "hooks/registry.json",
            "hooks.json",
            "mcp_config.json",
        ]
        + ["tests/fixtures/antigravity/**", "tests/fixtures/advisors/**"]
        + _paths(
            "tests/",
            (
                "test_mcp_server.py",
                ...
                "test_advisor_registry.py",
                "test_ag_history_sqlite.py",
                "test_agent_model_routing_docs.py",
                "test_agent_policy.py",
                "test_agent_policy_ux.py",
                "test_agents_catalog.py",
                "test_agents_cli.py",
                "test_antigravity_host_plugin.py",
                "test_antigravity_install.py",
                "test_ask_catalog.py",
                "test_command_family_agents.py",
                "test_consultation_legacy.py",
                "test_hooks_registry.py",
                "test_host_capabilities.py",
                "test_host_review_receipt.py",
                "test_medley_inspect.py",
                "test_skills_catalog.py",
                "test_tools_sidecar.py",
                "test_146_installed_plugin_smoke.py",
            ),
        )
    ),
    "OMG-W5": tuple(
    ...
    "OMG-W6": tuple(
        ...
        + [
            "omg_cli/ag_history.py",
            "omg_cli/agent_policy.py",
            "omg_cli/agent_policy_ux.py",
            "omg_cli/agents_catalog.py",
            "omg_cli/antigravity_install.py",
            "omg_cli/catalog_yaml.py",
            "omg_cli/hooks_registry.py",
            "omg_cli/host_capabilities.py",
            "omg_cli/install_manifest.py",
            "omg_cli/install_migrate.py",
            "omg_cli/medley_inspect.py",
            "omg_cli/memory_layers.py",
            "omg_cli/scip_codec.py",
            "omg_cli/session_acp.py",
            "omg_cli/session_index.py",
            "omg_cli/setup_fragments.py",
            "omg_cli/skills_catalog.py",
            "omg_cli/state_root.py",
            "omg_cli/tools_sidecar.py",
            "omg_cli/visual_pixels.py",
            "omg_cli/visual_runtime.py",
            "omg_cli/win32_nofollow.py",
            "omg_cli/contracts/advisor_contract.py",
            "omg_cli/contracts/consultation_contract.py",
            "omg_cli/contracts/visual_contract.py",
            "omg_cli/edit_hygiene/**",
            "omg_cli/hash_edit/**",
            "docs/architecture/**",
            "docs/hash-edit.md",
            "docs/hooks-lifecycle.md",
            "docs/install-manifest.md",
            "docs/install-manifest.zh.md",
            "docs/install-manifest.zh-TW.md",
            "docs/schemas/**",
            "docs/state-root.md",
            "docs/tools-sidecar.md",
            "docs/visual-contract-v1.md",
        ]
        + [
            "CLAUDE.md",
            "pyproject.toml",
        ...
        + _paths(
            ...
            (
                ...
                "test_command_family_visual.py",
                "test_comment_checker.py",
                "test_edit_simplify.py",
                "test_edit_verify.py",
                "test_hash_edit_apply.py",
                "test_hash_edit_cli.py",
                "test_hash_edit_descriptor.py",
                "test_hash_edit_planner.py",
                "test_install_manifest.py",
                "test_install_migrate.py",
                "test_install_migrate_win32.py",
                "test_jobs_grok_provider.py",
                "test_path_keys_win32.py",
                "test_scip_codec.py",
                "test_session_acp.py",
                "test_session_search.py",
                "test_state_root.py",
                "test_state_root_writers.py",
                "test_stock_host_medley_absent.py",
                "test_visual_cli.py",
                "test_visual_contract.py",
                "test_visual_pixels.py",
                "test_win32_nofollow.py",
                "jobs_grok_testutil.py",
                "stock_host_medley_absent_import_probe.py",
                "stock_host_medley_absent_smoke_bootstrap.py",
                "stock_host_medley_absent_support.py",
            ),
        )
        + [
            "tests/report_validator/test_mock_report.py",
            "tests/fixtures/hash_edit/**",
            "tests/fixtures/install/**",
            "tests/fixtures/session/**",
            "tests/fixtures/visual/**",
            "tests/fixtures/win32/**",
            "tests/fixtures/comment_checker/**",
            "tests/fixtures/docs/**",
            "tests/fixtures/jobs/**",
        ]
    ),
