...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("omg_cli/package_release.py", "OMG-W6"),
        ("omg_cli/release_bundle.py", "OMG-W6"),
        ("omg_cli/release_evidence.py", "OMG-W6"),
        ("omg_cli/release_upload.py", "OMG-W6"),
        ("scripts/release_github_facts.py", "OMG-W6"),
        ("scripts/release_upload_assets.py", "OMG-W6"),
        ("tests/test_release_bundle.py", "OMG-W6"),
        ("tests/test_release_evidence.py", "OMG-W6"),
        ("tests/test_release_upload.py", "OMG-W6"),
        ("tests/test_platform_host.py", "OMG-W6"),
