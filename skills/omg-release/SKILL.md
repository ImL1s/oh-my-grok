---
name: omg-release
description: Walk a release checklist via parity/bundle CLI. Use when the user says omg release or release checklist. Does not set verified.
---

# omg-release — Release checklist (parity/bundle)

Walk a release checklist via parity/bundle CLI. Use when the user says omg release or release checklist. Does not set verified.
...
## 1. Activation
- Phrases: `omg release`, `release checklist`
- Aliases: `release`
- **When:** Preparing bundle/evidence/readback — not claiming GitHub live publish succeeded without evidence.
- **Do not use when:** Forging verified or skipping parity gates.
- Informational questions (`what is omg-release?`) do **not** activate this skill.
...
## 3. Runtime owner
- omg-cli parity/release producers.
...
- Version + which producer the user asked for.
...
- `omg parity run|release-readback|release-bundle|release-evidence|check|gaps|refresh` as applicable. Notes under `.omg/artifacts/release/`.
