---
name: omg-best-practice-research
description: Research current best practices and write a brief under .omg/artifacts/. Use when the user asks for best-practice research before planning.
---

# omg-best-practice-research — Best-practice research (artifact brief)

Research current best practices and write a brief under .omg/artifacts/. Use when the user asks for best-practice research before planning.
...
## 1. Activation
- Phrases: `best practice research`, `best practices research`, `research best practices`
- Aliases: `best-practice-research`
- **When:** User wants a sourced best-practice brief before ralplan/implement.
- **Do not use when:** Implementing product code, starting a continuation loop, or claiming verified.
- Informational questions (`what is omg-best-practice-research?`) do **not** activate this skill.
...
## 3. Runtime owner
- omg-cli / this playbook. Explore fan-out is `spawn_subagent` depth=1, `read-only`.
...
- Goal + constraints + any prior interview notes. Output path `.omg/artifacts/best-practice-research.md`.
...
- `omg ask` is the advisory twin (human-brokered second opinion). Research notes go to artifacts.
