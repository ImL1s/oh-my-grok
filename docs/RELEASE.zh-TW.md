...
| Version | **0.7.3** |
| Intended tag | `v0.7.3` |
| Public assets | `oh-my-grok-0.7.3.tar.gz`，再來是 `SHA256SUMS` |
...
GitHub release 是 OMG 宣稱的發佈通道。xAI marketplace PR 仍屬可選，且需要該登錄當前 schema 加上精確 tag SHA。PyPI／非 editable wheel 與 npm 式套件登錄**不是** OMG 0.7.3 宣稱的發佈通道。發佈說明不要暗示否則。
