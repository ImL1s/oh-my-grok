...
# omg-security-research — Team security-research composition

Run Team security-research lanes. Use when the user says security-research. Team #69 — not live-verified.
...
## 1. Activation
- Phrases: `security research`, `security-research`
- Aliases: `security-research`
- **When:** Need hunt/validate composition CLI, not a casual security-review playbook.
- **Do not use when:** PoC exploits, live Antigravity workers, or verified from collect.
- Informational questions (`what is omg-security-research?`) do **not** activate this skill.
...
## 3. Runtime owner
- team plane. Isolation is integration-only.
...
- `omg team security-research plan|materialize|validate-report|produce-report|admit-tasks|collect-tasks|claim-lane|submit-lane-result|execute` (execute fixture-only).
