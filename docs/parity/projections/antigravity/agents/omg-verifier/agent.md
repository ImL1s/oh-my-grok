---
name: omg-verifier
description: OMG verifier (read-only, spawn=leaf)
mainAgent: false
subagent: true
hidden: false
inheritMcp: false
...
### Result schema
```json
{"verdict":"APPROVE|REQUEST_CHANGES|FAILED","evidence":[{"criterion":"...","result":"pass|fail|untested"}]}
```
