...
| --- | --- | --- | --- | --- | --- |
| `jobs.durable_background` | jobs | omg_native | grok=catalogued | catalogued | PR1 MVP landed (fake worker + job CLI); retry/GC/lease/ask--background and live Antigravity still open (#68). |
