...
| `omo.team.hyperplan_security` | team | omg_native | grok=catalogued | catalogued | Hyperplan V1 non-executing contract + Security Research V1 hermetic result production landed (#69 PR7/PR8/PR9; execution_supported=false). Hyperplan result production, Security Research composition execution, live Antigravity, and full OMX remain open under Team v3 (#69). |
