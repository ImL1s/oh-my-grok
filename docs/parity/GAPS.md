...
| `gap.jobs.durable` | P0 | open | #68 | `jobs.durable_background` | PR4 owner lease/heartbeat observation and explicit lost-job reconciliation landed. Automatic retry scheduling, Team job-backed workers (#69), and authenticated live Antigravity evidence remain open (#68). |
...
- `gap.jobs.durable` (#68): PR4 owner lease/heartbeat observation and explicit lost-job reconciliation landed. Automatic retry scheduling, Team job-backed workers (#69), and authenticated live Antigravity evidence remain open (#68).
