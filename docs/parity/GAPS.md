...
| `gap.omo.edit_and_hygiene` | P2 | open | #76, #79 | `omo.edit.hash_anchored`, `omo.quality.comment_hygiene` | CLI hash-edit (`omg edit plan/apply/verify`) and comment checker (`omg edit comments`, report-only default) supplement host edits; they do not claim `omo.edit.hash_anchored` host parity. Leftover owned by #76; #79 is aggregate tracker. |
