...
| `gap.team.v3` | P0 | open | #69 | `team.plane_v3` | PR4 job-backed workers + PR5 identity-fenced replace-worker + PR6 Presentation State V1 landed (hermetic pane/fake-job; CLI/API/MCP). Hyperplan/security compositions, live Antigravity proof, and full OMX operation surface remain open (#69). Depends on #67/#68 for remainder. |
...
- `gap.team.v3` (#69): PR4 job-backed workers + PR5 identity-fenced replace-worker + PR6 Presentation State V1 landed (hermetic pane/fake-job; CLI/API/MCP). Hyperplan/security compositions, live Antigravity proof, and full OMX operation surface remain open (#69). Depends on #67/#68 for remainder.
