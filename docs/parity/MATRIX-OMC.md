...
| `parity.inventory.governance` | parity_governance | omg_native | grok=catalogued | catalogued | #78-B catalogue inventory landed; #78-C refresh+claim gate landed; #78-D completeness proof gate landed; #78-E README↔JSON managed-snapshot drift gate landed; #78-F real pinned OMC discovery policy/mapping/proof landed; promotion remains unperformed and is proof-gated; OMX/OmO/Antigravity real-source proofs still open. |
