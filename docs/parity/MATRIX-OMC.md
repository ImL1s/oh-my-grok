...
| `omc.agents.catalog_routing` | agents_routing | omg_native | grok=catalogued | catalogued | YAML catalog + 23 omg-* agents, category routing (quick/deep/ultrabrain/visual-engineering/research/review), and static AG projections landed (#71). Live AG smoke / installed AG plugin remain unclaimed. Dual-host consume stays #131 overlay on this catalog. |
