...
| Agent model routing (canonical EN) | [../architecture/agent-model-routing.md](../architecture/agent-model-routing.md) | [same EN page](../architecture/agent-model-routing.md) | [same EN page](../architecture/agent-model-routing.md) |
