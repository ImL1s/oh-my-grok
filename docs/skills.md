...
omg team status --run RUN --presentation --json
# Hyperplan V1 hermetic produce + task driver (#69 PR12; non-executing; execution_supported=false):
...
# Security Research V1 hermetic produce + task driver (#69 PR12; execution_supported=false):
...
(#69 PR12), and `docs/team-security-research-v1.md` for Security Research V1
