...
| `omg provider antigravity capabilities\|doctor` | Antigravity (`agy`) probe only (#67-A): binary/version/compat envelope; no ask/Team cutover; never claims `live_call_ready`. |
