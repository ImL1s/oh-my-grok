...
| [visual-contract-v1.md](./visual-contract-v1.md) | Visual Contract V1 (pure `compare()` stays pixel-agnostic; runtime `omg visual overlay` may decode PNG; no approved/passes/verified) |
